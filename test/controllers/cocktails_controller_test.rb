...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { description: @cocktail.description, img: @cocktail.img, name: @cocktail.name, recipe: @cocktail.recipe } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { description: @cocktail.description, img: @cocktail.img, name: @cocktail.name, recipe: @cocktail.recipe } }
